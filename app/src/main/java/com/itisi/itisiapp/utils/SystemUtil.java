...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) ItisiApp.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
...
//            SnackbarUtil.showShort(container,"保存妹纸失败ヽ(≧Д≦)ノ");
    ...
    public static int dp2px(float dpValue) {
        final float scale = ItisiApp.getInstance().getResources().getDisplayMetrics().density;
        return (int) (dpValue * scale + 0.5f);
    }
